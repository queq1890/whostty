...
- **Tier 2 — quality / parity**: the native backend still pending is Harfbuzz
  `hb_shape` (the others — DirectWrite COM, **Direct3D 11**, multi-surface
  runtime, scrollbar drawing — are landed; see the rows above and #43), and the
  **full `config/` system** (#49):
